...
def files_home_view(request):
	...
	context["DISK1"] = "Total : " + str(int(round(hdd.total / (2**30),0))) + " GB\n" 
	context["DISK2"] = "Free : " + str(int(round(hdd.free / (2**30),0))) + " GB"
	context["CPU"] = psutil.cpu_percent()
	context["RAM"] = mem.percent
